        ...
        <div class="container-xl">
          ...
          <div class="navbar-nav flex-row order-md-last">
            <div class="nav-item d-none d-md-flex me-3">
              <div class="btn-list">
                <a href="documentation.php" class="btn" target="_blank" rel="noreferrer">
                ...
                <a href="https://github.com/NaveedMunsif/fcyber" class="btn" target="_blank" rel="noreferrer">
                  <!-- Download SVG icon from http://tabler-icons.io/i/brand-github -->
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                ...
                <div class="d-none d-xl-block ps-2">
                  <div>Group 06</div>
                  <div class="mt-1 small text-muted">WLU</div>
                </div>
              </a>
          ...
          <div class="navbar navbar-light">
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      ...
                      <a class="dropdown-item" href="tautology.php">
                        Tautology Attack
                        </a>
                        <a class="dropdown-item" href="end.php">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="countermeasure.php">
